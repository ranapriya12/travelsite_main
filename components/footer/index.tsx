  ...
  return (
    <footer className="site-footer">
      <div className="container">
        <div className="site-footer__top">
          <div className="site-footer__description">
            ...
            <p>One Trip is Nurtured from the seed of a single great idea - to empower the traveller - OneTrip is a pioneer in India's online travel industry. Founded in the year 2022 by Priya Rana.</p>
          ...
          <div className="site-footer__links">
            ...
            <ul>
              <li>Contact</li>
              <li>ranapriya1245@gmail.com</li>
              <li>Hotline: +91 8755835952</li>
            </ul>
          </div>
        </div>
      </div>
      ...
      <div className="site-footer__bottom">
        <div className="container">
          <p>DESIGN BY PRIYA RANA - © 2022. ALL RIGHTS RESERVED.</p>
        </div>
      </div>
    </footer>
  )
